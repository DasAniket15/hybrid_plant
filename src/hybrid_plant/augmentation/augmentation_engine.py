...
This module is the single entry point used by:
  • SolverEngine.run_augmentation_aware()  (Pass 2 Optuna trials)
  • run_model.__main__                     (post-processing baseline best)
  • Dashboard rendering                    (sections 6b and 8)
...
class AugmentationEngine:
    ...
    trigger_threshold_cuf : float — baseline Year-1 Plant CUF (Pass-1 output)
    """
